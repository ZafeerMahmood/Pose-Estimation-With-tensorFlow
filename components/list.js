...
function List({heading,subheading,link,distance}) {
  return (
    <div>
         <div className=" w-full p-6 px-20 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                <a href="#">
                ...
                <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">distance traveled : {distance}.</p>
